...
public class DispatcherManager implements DispatcherDetectorListener {
    ...
    public void forward(ISource source) {
        ...
        /**
         * eg. Service(1)
         * {@link org.apache.skywalking.oap.server.core.analysis.manual.service.ServiceTrafficDispatcher}
         * {@link org.apache.skywalking.oap.server.core.source.oal.rt.dispatcher.ServiceDispatcher}
         * {@link org.apache.skywalking.oap.server.core.source.oal.rt.dispatcher.ServiceMeshServiceDispatcher}
         */
        System.out.println("my|DispatcherManager|forward|dispatcherMap = " + dispatcherMap.get(1));
        // eg. 如果是 CacheAccess 入口进来，拿到的 dispatcher 是 CacheAccessDispatcher(根据 core.oal 配置自动生成)
         ...
         * Dispatcher 只是由 oal 脚本分析结果生成的。
         * 所以这些将/可能是可能的，给定的源没有调度程序，
         * 当接收者打开时，oal 脚本不要求分析。
         */
        if (dispatchers != null) {
            source.prepare();
